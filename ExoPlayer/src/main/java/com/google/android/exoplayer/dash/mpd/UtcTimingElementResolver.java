 ...
 */
public
class UtcTimingElementResolver implements Loader.Callback {

	/**
	 * Callback for timing element resolution.
	 */
	public
	interface UtcTimingCallback {
	 ...
	 */
	public static
	void resolveTimingElement(UriDataSource uriDataSource,
	...
	private
	UtcTimingElementResolver(UriDataSource uriDataSource, UtcTimingElement timingElement,
	...
	private
	void resolveHttp(UriLoadable.Parser<Long> parser) {
	...
	private static
	class XsDateTimeParser implements UriLoadable.Parser<Long> {

		@Override
		public
		Long parse(String connectionUrl, InputStream inputStream) throws ParserException,
		IOException {
	...
	private static
	class Iso8601Parser implements UriLoadable.Parser<Long> {
