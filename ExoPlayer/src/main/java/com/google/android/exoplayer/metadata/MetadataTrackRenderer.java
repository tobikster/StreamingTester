 ...
 */
public
class MetadataTrackRenderer<T> extends TrackRenderer implements Callback {
	 ...
	 */
	public
	MetadataTrackRenderer(SampleSource source, MetadataParser<T> metadataParser,
	...
	private
	void invokeRenderer(T metadata) {
	...
	private
	void invokeRendererInternal(T metadata) {
