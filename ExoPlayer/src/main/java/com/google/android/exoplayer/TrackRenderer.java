 ...
 */
public abstract
class TrackRenderer implements ExoPlayerComponent {
  ...
  /* package */
	final
	int prepare(long positionUs) throws ExoPlaybackException {
  ...
  /* package */
	final
	void enable(long positionUs, boolean joining) throws ExoPlaybackException {
	 ...
	 */
	protected
	void onEnabled(long positionUs, boolean joining) throws ExoPlaybackException {
		// Do nothing.
	}
  ...
  /* package */
	 ...
	 */
	protected
	void onStarted() throws ExoPlaybackException {
		// Do nothing.
	}
  ...
  /* package */
	 ...
	 */
	protected
	void onStopped() throws ExoPlaybackException {
		// Do nothing.
	}
  ...
  /* package */
	final
	void disable() throws ExoPlaybackException {
		Assertions.checkState(state == TrackRenderer.STATE_ENABLED);
		state = TrackRenderer.STATE_PREPARED;
		onDisabled();
	}
	 ...
	 */
	protected
	void onDisabled() throws ExoPlaybackException {
		// Do nothing.
	}
  ...
  /* package */
	final
	void release() throws ExoPlaybackException {
		Assertions.checkState(state != TrackRenderer.STATE_ENABLED
				                      && state != TrackRenderer.STATE_STARTED
	 ...
	 */
	protected
	void onReleased() throws ExoPlaybackException {
		// Do nothing.
	}
	 ...
	 */
	protected abstract
	void doSomeWork(long positionUs, long elapsedRealtimeUs)
	...
	@Override
	public
	void handleMessage(int what, Object object) throws ExoPlaybackException {
		// Do nothing.
	}
