...
class HlsChunkSource {
	...
	public
	HlsChunkSource(DataSource dataSource, String playlistUrl, HlsPlaylist playlist,
	 ...
	 */
	public
	Chunk getChunkOperation(TsChunk previousTsChunk, long seekPositionUs,
	 ...
	 */
	public
	boolean onChunkLoadError(Chunk chunk, IOException e) {
	...
	private
	int getNextFormatIndex(TsChunk previousTsChunk, long playbackPositionUs) {
	...
	private
	int getFormatIndexForBandwidth(int bitrate) {
	...
	private
	boolean shouldRerequestMediaPlaylist(int variantIndex) {
	...
	private
	int getLiveStartChunkMediaSequence(int variantIndex) {
	...
	private
	MediaPlaylistChunk newMediaPlaylistChunk(int variantIndex) {
	...
	private
	EncryptionKeyChunk newEncryptionKeyChunk(Uri keyUri, String iv) {
	...
	private static
	Format[] buildEnabledFormats(List<Variant> variants, int[] variantIndices) {
	...
	private static
	boolean variantHasExplicitCodecWithPrefix(Variant variant, String prefix) {
	...
	private
	boolean allPlaylistsBlacklisted() {
	...
	private
	void clearStaleBlacklistedPlaylists() {
	...
	private
	int getVariantIndex(Format format) {
	...
	class MediaPlaylistChunk extends DataChunk {
		...
		public
		MediaPlaylistChunk(DataSource dataSource, DataSpec dataSpec, byte[] scratchSpace,
	...
	class EncryptionKeyChunk extends DataChunk {
		...
		public
		EncryptionKeyChunk(DataSource dataSource, DataSpec dataSpec, byte[] scratchSpace,
		                   String iv) {
