...
/* package */ final
	 ...
	 */
	public
	void initTables(int sampleCount) {
		length = sampleCount;
	 ...
	 */
	public
	void initEncryptionData(int length) {
	 ...
	 */
	public
	void fillEncryptionData(ExtractorInput input) throws IOException, InterruptedException {
	 ...
	 */
	public
	void fillEncryptionData(ParsableByteArray source) {
	...
	public
	long getSamplePresentationTime(int index) {
