 ...
 */
/* package */ final
              class VbriSeeker implements Mp3Extractor.Seeker {
	 ...
	 */
	public static
	VbriSeeker create(MpegAudioHeader mpegAudioHeader, ParsableByteArray frame,
	                  long position) {
		frame.skipBytes(10);
	...
	private
	VbriSeeker(long[] timesUs, long[] positions, long basePosition, long durationUs) {
