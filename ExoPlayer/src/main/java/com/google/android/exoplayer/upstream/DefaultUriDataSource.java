 ...
 */
public final
class DefaultUriDataSource implements UriDataSource {
	 ...
	 */
	public
	DefaultUriDataSource(Context context, String userAgent) {
	 ...
	 */
	public
	DefaultUriDataSource(Context context, TransferListener listener, String userAgent) {
	 ...
	 */
	public
	DefaultUriDataSource(Context context, TransferListener listener,
