 ...
 */
public abstract
class Representation implements FormatWrapper {
	 ...
	 */
	public static
	Representation newInstance(long periodStartMs, long periodDurationMs,
	...
	private
	Representation(long periodStartMs, long periodDurationMs, String contentId,
	...
	class SingleSegmentRepresentation extends Representation {
		 ...
		 */
		public static
		SingleSegmentRepresentation newInstance(long periodStartMs, long periodDurationMs,
		 ...
		 */
		public
		SingleSegmentRepresentation(long periodStartMs, long periodDurationMs, String contentId,
	...
	class MultiSegmentRepresentation extends Representation
		 ...
		 */
		public
		MultiSegmentRepresentation(long periodStartMs, long periodDurationMs, String contentId,
		...
		@Override
		public
		RangedUri getSegmentUrl(int segmentIndex) {
		...
		@Override
		public
		long getTimeUs(int segmentIndex) {
			return segmentBase.getSegmentTimeUs(segmentIndex);
		}

		@Override
		public
		long getDurationUs(int segmentIndex) {
