...
@TargetApi(18)
public
class StreamingDrmSessionManager implements DrmSessionManager {
	 ...
	 */
	public static
	StreamingDrmSessionManager newWidevineInstance(Looper playbackLooper,
	 ...
	 */
	public static
	StreamingDrmSessionManager newPlayReadyInstance(Looper playbackLooper,
	 ...
	 */
	public
	StreamingDrmSessionManager(UUID uuid, Looper playbackLooper, MediaDrmCallback callback,
	 ...
	 */
	public final
	byte[] getPropertyByteArray(String key) {
	 ...
	 */
	public final
	void setPropertyByteArray(String key, byte[] value) {
	...
	private
	void openInternal(boolean allowProvisioning) {
		try {
	...
	private
	void onProvisionResponse(Object response) {
		provisioningInProgress = false;
