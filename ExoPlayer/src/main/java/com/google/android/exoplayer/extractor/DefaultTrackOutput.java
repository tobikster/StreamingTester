 ...
 */
public
class DefaultTrackOutput implements TrackOutput {
	 ...
	 */
	public
	boolean getSample(SampleHolder holder) {
	 ...
	 */
	public
	boolean configureSpliceTo(DefaultTrackOutput nextQueue) {
	 ...
	 */
	private
	boolean advanceToEligibleSample() {
	...
	public
	int sampleData(DataSource dataSource, int length) throws IOException {
	...
	@Override
	public
	void sampleData(ParsableByteArray buffer, int length) {
