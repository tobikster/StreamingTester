 ...
 */
public final
class HlsPlaylistParser implements UriLoadable.Parser<HlsPlaylist> {
	...
	@Override
	public
	HlsPlaylist parse(String connectionUrl, InputStream inputStream)
	...
	private static
	HlsMasterPlaylist parseMasterPlaylist(LineIterator iterator, String baseUri)
	throws IOException {
	...
	private static
	HlsMediaPlaylist parseMediaPlaylist(LineIterator iterator, String baseUri)
	throws IOException {
		int mediaSequence = 0;
