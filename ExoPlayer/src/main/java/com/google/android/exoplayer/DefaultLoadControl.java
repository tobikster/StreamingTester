 ...
 */
public
class DefaultLoadControl implements LoadControl {
	 ...
	 */
	public
	DefaultLoadControl(Allocator allocator, Handler eventHandler,
	 ...
	 */
	public
	DefaultLoadControl(Allocator allocator, Handler eventHandler, EventListener eventListener,
	...
	private
	int getLoaderBufferState(long playbackPositionUs, long nextLoadPositionUs) {
	...
	private
	int getBufferState(int currentBufferSize) {
	...
	private
	void notifyLoadingChanged(final boolean loading) {
	...
	class LoaderState {
		...
		public
		LoaderState(int bufferSizeContribution) {
