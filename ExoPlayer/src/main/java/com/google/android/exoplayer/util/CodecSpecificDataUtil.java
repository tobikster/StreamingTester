...
class CodecSpecificDataUtil {
	 ...
	 */
	public static
	Pair<Integer, Integer> parseAudioSpecificConfig(byte[] audioSpecificConfig) {
	 ...
	 */
	public static
	byte[] buildAudioSpecificConfig(int audioObjectType, int sampleRateIndex,
	                                int channelConfig) {
	 ...
	 */
	public static
	byte[] buildAudioSpecificConfig(int sampleRate, int numChannels) {
	 ...
	 */
	public static
	byte[] buildNalUnit(byte[] data, int offset, int length) {
	 ...
	 */
	private static
	int findNalStartCode(byte[] data, int index) {
	 ...
	 */
	private static
	boolean isNalStartCode(byte[] data, int index) {
	 ...
	 */
	public static
	Pair<Integer, Integer> parseSpsNalUnit(byte[] spsNalUnit) {
		// SPS NAL unit:
