...
class SegmentBase {
	...
	class SingleSegmentBase extends SegmentBase {
		 ...
		 */
		public
		SingleSegmentBase(RangedUri initialization, long timescale, long presentationTimeOffset,
	...
	class MultiSegmentBase extends SegmentBase {
		 ...
		 */
		public
		MultiSegmentBase(RangedUri initialization, long timescale, long presentationTimeOffset,
		 ...
		 */
		public final
		long getSegmentDurationUs(int sequenceNumber) {
			if(segmentTimeline != null) {
		 ...
		 */
		public final
		long getSegmentTimeUs(int sequenceNumber) {
	...
	class SegmentTemplate extends MultiSegmentBase {
		 ...
		 */
		public
		SegmentTemplate(RangedUri initialization, long timescale, long presentationTimeOffset,
		                long periodDurationMs, int startNumber, long duration,
