 ...
 */
public
class ContainerMediaChunk extends BaseMediaChunk implements SingleTrackOutput {
	 ...
	 */
	public
	ContainerMediaChunk(DataSource dataSource, DataSpec dataSpec, int trigger, Format format,
