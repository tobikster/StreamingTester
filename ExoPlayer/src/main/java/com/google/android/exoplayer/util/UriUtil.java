...
class UriUtil {
	 ...
	 */
	public static
	Uri resolveToUri(String baseUri, String referenceUri) {
	 ...
	 */
	public static
	String resolve(String baseUri, String referenceUri) {
	 ...
	 */
	private static
	String removeDotSegments(StringBuilder uri, int offset, int limit) {
		if(offset >= limit) {
			// Nothing to do.
			return uri.toString();
		}
	 ...
	 */
	private static
	int[] getUriIndices(String uriString) {
