...
@TargetApi(16)
public
class TextTrackRenderer extends TrackRenderer implements Callback {
	 ...
	 */
	public
	TextTrackRenderer(SampleSource source, TextRenderer textRenderer,
	...
	private
	void syncNextEventIndex(long positionUs) {
	...
	private
	void updateTextRenderer(long positionUs) {
