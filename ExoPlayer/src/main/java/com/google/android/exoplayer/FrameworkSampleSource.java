...
@TargetApi(16)
public final
class FrameworkSampleSource implements SampleSource {
	 ...
	 */
	public
	FrameworkSampleSource(Context context, Uri uri, Map<String, String> headers,
	 ...
	 */
	public
	FrameworkSampleSource(FileDescriptor fileDescriptor, long offset, long length,
	                      int downstreamRendererCount) {
		Assertions.checkState(Util.SDK_INT >= 16);
		this.remainingReleaseCount = downstreamRendererCount;
	...
	private
	void seekToUsInternal(long positionUs, boolean force) {
