...
class CryptoInfo {
	 ...
	 */
	public
	void set(int numSubSamples, int[] numBytesOfClearData, int[] numBytesOfEncryptedData,
	...
	@TargetApi(16)
	public
	void setFromExtractorV16(MediaExtractor extractor) {
	...
	@TargetApi(16)
	public
	android.media.MediaCodec.CryptoInfo getFrameworkCryptoInfoV16() {
	...
	@TargetApi(16)
	private
	void updateFrameworkCryptoInfoV16() {
