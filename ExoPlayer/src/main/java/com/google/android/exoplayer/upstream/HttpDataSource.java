...
interface HttpDataSource extends UriDataSource {
	...
	public static final Predicate<String> REJECT_PAYWALL_TYPES = new Predicate<String>() {
		...
		@Override
		public
		boolean evaluate(String contentType) {
	...
	class HttpDataSourceException extends IOException {
		...
		public
		HttpDataSourceException(String message, DataSpec dataSpec) {
			super(message);
			this.dataSpec = dataSpec;
		}

		public
		HttpDataSourceException(IOException cause, DataSpec dataSpec) {
			super(cause);
			this.dataSpec = dataSpec;
		}
	 ...
	 */
	public static final
	class InvalidContentTypeException extends HttpDataSourceException {
	 ...
	 */
	public static final
	class InvalidResponseCodeException extends HttpDataSourceException {
