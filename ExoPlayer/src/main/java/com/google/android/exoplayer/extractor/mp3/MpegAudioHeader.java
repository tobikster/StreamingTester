...
/* package */ final
	 ...
	 */
	public static
	void populateHeader(int headerData, MpegAudioHeader header) {
	...
	private
	void setValues(int version, int layerIndex, int frameSize, int sampleRate, int channels,
