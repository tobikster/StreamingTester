 ...
 */
public final
class InitializationChunk extends Chunk implements SingleTrackOutput {
	 ...
	 */
	public
	InitializationChunk(DataSource dataSource, DataSpec dataSpec, int trigger, Format format,
	...
	void load() throws IOException, InterruptedException {
		...
		try {
			...
			ExtractorInput input = new DefaultExtractorInput(dataSource,
			                                                 loadDataSpec.absoluteStreamPosition, dataSource
					                                                                                      .open(loadDataSpec));
			if(bytesLoaded == 0) {
