...
class MimeTypes {
	 ...
	 */
	public static
	String getTopLevelType(String mimeType) {
	 ...
	 */
	public static
	boolean isApplication(String mimeType) {
	 ...
	 */
	public static
	boolean isTtml(String mimeType) {
	 ...
	 */
	public static
	int getEncodingForMimeType(String mimeType) {
	 ...
	 */
	public static
	boolean isPassthroughAudio(String mimeType) {
