...
class MediaCodecUtil {
	 ...
	 */
	public static
	class DecoderQueryException extends Exception {

		private
		DecoderQueryException(Throwable cause) {
	 ...
	 */
	public static
	DecoderInfo getDecoderInfo(String mimeType, boolean secure)
	...
	void warmCodec(String mimeType, boolean secure) {
		try {
	...
	Pair<String, CodecCapabilities> getMediaCodecInfo(
	...
	private static
	Pair<String, CodecCapabilities> getMediaCodecInfo(CodecKey key,
	...
	private static
	Pair<String, CodecCapabilities> getMediaCodecInfoInternal(CodecKey key,
	...
	private static
	boolean isAdaptive(CodecCapabilities capabilities) {
		if(Util.SDK_INT >= 19) {
	...
	@TargetApi(19)
	private static
	boolean isAdaptiveV19(CodecCapabilities capabilities) {
	...
	@TargetApi(21)
	public static
	boolean isSizeAndRateSupportedV21(String mimeType, boolean secure,
	 ...
	 */
	public static
	boolean isH264ProfileSupported(int profile, int level)
			throws DecoderQueryException {
	 ...
	 */
	public static
	int maxH264DecodableFrameSize() throws DecoderQueryException {
		Pair<String, CodecCapabilities> info = getMediaCodecInfo(MimeTypes.VIDEO_H264, false);
		if(info == null) {
			return 0;
		}
	 ...
	 */
	private static
	int avcLevelToMaxFrameSize(int avcLevel) {
		switch(avcLevel) {
	...
	class MediaCodecListCompatV21 implements MediaCodecListCompat {
		...
		private
		void ensureMediaCodecInfosInitialized() {
	...
	private static final
	class MediaCodecListCompatV16 implements MediaCodecListCompat {
