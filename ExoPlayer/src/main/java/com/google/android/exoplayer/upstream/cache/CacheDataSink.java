 ...
 */
public
class CacheDataSink implements DataSink {
	 ...
	 */
	public static
	class CacheDataSinkException extends IOException {
	...
	@Override
	public
	void write(byte[] buffer, int offset, int length) throws CacheDataSinkException {
		try {
			int bytesWritten = 0;
	...
	@Override
	public
	void close() throws CacheDataSinkException {
		try {
			closeCurrentOutputStream();
		}
		catch(IOException e) {
	...
	private
	void openNextOutputStream() throws FileNotFoundException {
	...
	private
	void closeCurrentOutputStream() throws IOException {
