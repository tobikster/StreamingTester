 ...
 */
/* package */ final
              class XingSeeker implements Mp3Extractor.Seeker {
	 ...
	 */
	public static
	XingSeeker create(MpegAudioHeader mpegAudioHeader, ParsableByteArray frame,
	...
	private
	XingSeeker(long[] tableOfContents, long firstFramePosition, long sizeBytes,
	...
	private
	long getTimeUsForTocIndex(int tocIndex) {
