...
class SubtitleView extends View {
	...
	SubtitleView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		int[] viewAttr = {
				                 android.R.attr.text, android.R.attr.textSize,
	...
	private
	void forceUpdate(boolean needsLayout) {
		if(needsLayout) {
	...
	@TargetApi(11)
	private
	void setTooSmallMeasureDimensionV11() {
	...
	private
	boolean computeMeasurements(int maxWidth) {
