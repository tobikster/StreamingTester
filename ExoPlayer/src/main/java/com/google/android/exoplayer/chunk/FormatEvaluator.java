...
interface FormatEvaluator {
	 ...
	 */
	public static final
	class FixedEvaluator implements FormatEvaluator {
	 ...
	 */
	public static final
	class RandomEvaluator implements FormatEvaluator {
	 ...
	 */
	public static final
	class AdaptiveEvaluator implements FormatEvaluator {
		 ...
		 */
		private
		Format determineIdealFormat(Format[] formats, long bitrateEstimate) {
