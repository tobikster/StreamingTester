 ...
 */
public
class Id3Parser implements MetadataParser<Map<String, Object>> {
	...
	@Override
	public
	Map<String, Object> parse(byte[] data, int size)
	...
	private static
	int indexOf(byte[] data, int fromIndex, byte key) {
	...
	private static
	int indexOfEOS(byte[] data, int fromIndex, int encodingByte) {
	...
	private static
	int delimiterLength(int encodingByte) {
	 ...
	 */
	private static
	int parseId3Header(ParsableByteArray id3Buffer) throws ParserException {
	 ...
	 */
	private static
	String getCharsetName(int encodingByte) {
		switch(encodingByte) {
