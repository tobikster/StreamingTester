 ...
 */
public
class Eia608TrackRenderer extends TrackRenderer implements Callback {
	 ...
	 */
	public
	Eia608TrackRenderer(SampleSource source, TextRenderer textRenderer,
	...
	private
	void seekToInternal(long positionUs) {
	...
	private
	void invokeRenderer(String text) {
	...
	private
	void invokeRendererInternal(String text) {
		textRenderer.onText(text);
	}

	private
	void maybeParsePendingSample() {
	...
	private
	void consumeCaptionList(ClosedCaptionList captionList) {
	...
	private
	void handleText(ClosedCaptionText captionText) {
	...
	private
	void handleMiscCode(ClosedCaptionCtrl captionCtrl) {
	...
	private
	void handlePreambleAddressCode() {
		// TODO: Add better handling of this with specific positioning.
		maybeAppendNewline();
	}

	private
	void setCaptionMode(int captionMode) {
