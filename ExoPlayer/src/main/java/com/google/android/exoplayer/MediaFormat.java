...
class MediaFormat {
	...
	@TargetApi(16)
	public static
	MediaFormat createFromFrameworkMediaFormatV16(android.media.MediaFormat format) {
		return new MediaFormat(format);
	}

	public static
	MediaFormat createVideoFormat(String mimeType, int maxInputSize, int width,
	...
	public static
	MediaFormat createVideoFormat(String mimeType, int maxInputSize, long durationUs,
	...
	public static
	MediaFormat createAudioFormat(String mimeType, int maxInputSize, int channelCount,
	...
	public static
	MediaFormat createAudioFormat(String mimeType, int maxInputSize, long durationUs,
	...
	@TargetApi(16)
	private
	MediaFormat(android.media.MediaFormat format) {
	...
	private
	MediaFormat(String mimeType, int maxInputSize, long durationUs, int width, int height,
	...
	public
	void setMaxVideoDimensions(int maxWidth, int maxHeight) {
	...
	public
	boolean equals(MediaFormat other, boolean ignoreMaxDimensions) {
		if(this == other) {
			return true;
		}
		if(other == null) {
	...
	private
	boolean equalsInternal(MediaFormat other, boolean ignoreMaxDimensions) {
	...
	@TargetApi(16)
	public final
	android.media.MediaFormat getFrameworkMediaFormatV16() {
		if(frameworkMediaFormat == null) {
	...
	@TargetApi(16)
	private final
	void maybeSetMaxDimensionsV16(android.media.MediaFormat format) {
	...
	void maybeSetIntegerV16(android.media.MediaFormat format, String key,
	                        int value) {
		if(value != NO_VALUE) {
	...
	@TargetApi(16)
	private static final
	void maybeSetFloatV16(android.media.MediaFormat format, String key,
	                      float value) {
		if(value != NO_VALUE) {
	...
	@TargetApi(16)
	private static final
	int getOptionalIntegerV16(android.media.MediaFormat format, String key) {
		return format.containsKey(key) ? format.getInteger(key) : NO_VALUE;
	}

	@TargetApi(16)
	private static final
	float getOptionalFloatV16(android.media.MediaFormat format, String key) {
