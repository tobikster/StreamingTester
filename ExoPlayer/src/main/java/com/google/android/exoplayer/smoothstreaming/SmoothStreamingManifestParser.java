 ...
 */
public
class SmoothStreamingManifestParser implements UriLoadable.Parser<SmoothStreamingManifest> {
	...
	@Override
	public
	SmoothStreamingManifest parse(String connectionUrl, InputStream inputStream)
	 ...
	 */
	public static
	class MissingFieldException extends ParserException {
	...
	class ElementParser {
		...
		public
		ElementParser(ElementParser parent, String baseUri, String tag) {
			this.parent = parent;
		...
		public final
		Object parse(XmlPullParser xmlParser) throws XmlPullParserException, IOException,
		ParserException {
			String tagName;
		...
		private
		ElementParser newChildParser(ElementParser parent, String name, String baseUri) {
		 ...
		 */
		protected final
		void putNormalizedAttribute(String key, Object value) {
		 ...
		 */
		protected final
		Object getNormalizedAttribute(String key) {
		 ...
		 */
		protected
		boolean handleChildInline(String tagName) {
			return false;
		}
		 ...
		 */
		protected
		void parseStartTag(XmlPullParser xmlParser) throws ParserException {
			// Do nothing.
		}
		 ...
		 */
		protected
		void parseText(XmlPullParser xmlParser) throws ParserException {
			// Do nothing.
		}
		 ...
		 */
		protected
		void parseEndTag(XmlPullParser xmlParser) throws ParserException {
			// Do nothing.
		}
		 ...
		 */
		protected
		void addChild(Object parsedChild) {
			// Do nothing.
		}
		...
		protected final
		String parseRequiredString(XmlPullParser parser, String key)
		...
		protected final
		int parseInt(XmlPullParser parser, String key, int defaultValue)
		throws ParserException {
			String value = parser.getAttributeValue(null, key);
			if(value != null) {
				try {
		...
		protected final
		int parseRequiredInt(XmlPullParser parser, String key) throws ParserException {
			String value = parser.getAttributeValue(null, key);
			if(value != null) {
				try {
					return Integer.parseInt(value);
		...
		protected final
		long parseLong(XmlPullParser parser, String key, long defaultValue)
		throws ParserException {
			String value = parser.getAttributeValue(null, key);
			if(value != null) {
				try {
		...
		protected final
		long parseRequiredLong(XmlPullParser parser, String key)
		throws ParserException {
			String value = parser.getAttributeValue(null, key);
			if(value != null) {
				try {
		...
		protected final
		boolean parseBoolean(XmlPullParser parser, String key, boolean defaultValue) {
			String value = parser.getAttributeValue(null, key);
			if(value != null) {
	...
	class SmoothStreamMediaParser extends ElementParser {
		...
		public
		SmoothStreamMediaParser(ElementParser parent, String baseUri) {
		...
		@Override
		public
		void parseStartTag(XmlPullParser parser) throws ParserException {
	...
	class ProtectionElementParser extends ElementParser {
		...
		public
		ProtectionElementParser(ElementParser parent, String baseUri) {
			super(parent, baseUri, TAG);
		}

		@Override
		public
		boolean handleChildInline(String tag) {
			return TAG_PROTECTION_HEADER.equals(tag);
		}

		@Override
		public
		void parseStartTag(XmlPullParser parser) {
		...
		@Override
		public
		void parseEndTag(XmlPullParser parser) {
			if(TAG_PROTECTION_HEADER.equals(parser.getName())) {
	...
	class StreamElementParser extends ElementParser {
		...
		public
		StreamElementParser(ElementParser parent, String baseUri) {
			super(parent, baseUri, TAG);
			this.baseUri = baseUri;
		...
		private
		void parseStreamFragmentStartTag(XmlPullParser parser) throws ParserException {
		...
		private
		void parseStreamElementStartTag(XmlPullParser parser) throws ParserException {
		...
		private
		int parseType(XmlPullParser parser) throws ParserException {
	...
	class TrackElementParser extends ElementParser {
		...
		public
		TrackElementParser(ElementParser parent, String baseUri) {
			super(parent, baseUri, TAG);
		...
		private static
		String fourCCToMimeType(String fourCC) {
