 ...
 */
public
class MediaPresentationDescriptionParser extends DefaultHandler
	...
	@Override
	public
	MediaPresentationDescription parse(String connectionUrl, InputStream inputStream)
	...
	protected
	MediaPresentationDescription parseMediaPresentationDescription(XmlPullParser xpp,
	...
	protected
	MediaPresentationDescription buildMediaPresentationDescription(
	...
	protected
	UtcTimingElement parseUtcTiming(XmlPullParser xpp) {
	...
	protected
	UtcTimingElement buildUtcTimingElement(String schemeIdUri, String value) {
		return new UtcTimingElement(schemeIdUri, value);
	}

	protected
	Period parsePeriod(XmlPullParser xpp, String baseUrl, long mpdDurationMs)
	...
	protected
	AdaptationSet parseAdaptationSet(XmlPullParser xpp, String baseUrl, long periodStartMs,
	...
	protected
	AdaptationSet buildAdaptationSet(int id, int contentType,
	...
	protected
	int parseAdaptationSetType(String contentType) {
	...
	protected
	int parseAdaptationSetTypeFromMimeType(String mimeType) {
	 ...
	 */
	private
	int checkAdaptationSetTypeConsistency(int firstType, int secondType) {
	 ...
	 */
	protected
	ContentProtection parseContentProtection(XmlPullParser xpp)
			throws XmlPullParserException, IOException {
		String schemeIdUri = xpp.getAttributeValue(null, "schemeIdUri");
		UUID uuid = null;
		byte[] data = null;
	...
	protected
	ContentProtection buildContentProtection(String schemeIdUri, UUID uuid, byte[] data) {
	 ...
	 */
	protected
	void parseAdaptationSetChild(XmlPullParser xpp)
			throws XmlPullParserException, IOException {
		// pass
	}
	...
	protected
	Representation parseRepresentation(XmlPullParser xpp, String baseUrl,
	...
	protected
	Format buildFormat(String id, String mimeType, int width, int height, float frameRate,
	...
	protected
	Representation buildRepresentation(long periodStartMs, long periodDurationMs,
	...
	protected
	SingleSegmentBase parseSegmentBase(XmlPullParser xpp, String baseUrl,
	...
	protected
	SingleSegmentBase buildSingleSegmentBase(RangedUri initialization, long timescale,
	...
	protected
	SegmentList parseSegmentList(XmlPullParser xpp, String baseUrl, SegmentList parent,
	...
	protected
	SegmentList buildSegmentList(RangedUri initialization, long timescale,
	...
	protected
	SegmentTemplate parseSegmentTemplate(XmlPullParser xpp, String baseUrl,
	...
	protected
	SegmentTemplate buildSegmentTemplate(RangedUri initialization, long timescale,
	                                     long presentationTimeOffset, long periodDurationMs, int startNumber, long duration,
	...
	protected
	List<SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xpp)
	throws XmlPullParserException, IOException {
	...
	protected
	SegmentTimelineElement buildSegmentTimelineElement(long elapsedTime, long duration) {
		return new SegmentTimelineElement(elapsedTime, duration);
	}

	protected
	UrlTemplate parseUrlTemplate(XmlPullParser xpp, String name,
	...
	protected
	RangedUri parseInitialization(XmlPullParser xpp, String baseUrl) {
		return parseRangedUrl(xpp, baseUrl, "sourceURL", "range");
	}

	protected
	RangedUri parseSegmentUrl(XmlPullParser xpp, String baseUrl) {
		return parseRangedUrl(xpp, baseUrl, "media", "mediaRange");
	}

	protected
	RangedUri parseRangedUrl(XmlPullParser xpp, String baseUrl, String urlAttribute,
	...
	protected
	RangedUri buildRangedUri(String baseUrl, String urlText, long rangeStart,
	                         long rangeLength) {
	...
	protected static
	boolean isEndTag(XmlPullParser xpp, String name) throws XmlPullParserException {
		return xpp.getEventType() == XmlPullParser.END_TAG && name.equals(xpp.getName());
	}

	protected static
	boolean isStartTag(XmlPullParser xpp, String name)
	throws XmlPullParserException {
		return xpp.getEventType() == XmlPullParser.START_TAG && name.equals(xpp.getName());
	}

	protected static
	boolean isStartTag(XmlPullParser xpp) throws XmlPullParserException {
		return xpp.getEventType() == XmlPullParser.START_TAG;
	}

	protected static
	long parseDuration(XmlPullParser xpp, String name, long defaultValue) {
	...
	protected static
	long parseDateTime(XmlPullParser xpp, String name, long defaultValue)
	...
	protected static
	String parseBaseUrl(XmlPullParser xpp, String parentBaseUrl)
	throws XmlPullParserException, IOException {
		xpp.next();
	...
	protected static
	int parseInt(XmlPullParser xpp, String name) {
		return parseInt(xpp, name, -1);
	}

	protected static
	int parseInt(XmlPullParser xpp, String name, int defaultValue) {
		String value = xpp.getAttributeValue(null, name);
		return value == null ? defaultValue : Integer.parseInt(value);
	}

	protected static
	long parseLong(XmlPullParser xpp, String name) {
		return parseLong(xpp, name, -1);
	}

	protected static
	long parseLong(XmlPullParser xpp, String name, long defaultValue) {
		String value = xpp.getAttributeValue(null, name);
		return value == null ? defaultValue : Long.parseLong(value);
	}

	protected static
	String parseString(XmlPullParser xpp, String name, String defaultValue) {
		String value = xpp.getAttributeValue(null, name);
	...
	class ContentProtectionsBuilder implements Comparator<ContentProtection> {
		 ...
		 */
		public
		void addAdaptationSetProtection(ContentProtection contentProtection) {
		 ...
		 */
		public
		void addRepresentationProtection(ContentProtection contentProtection) {
		 ...
		 */
		public
		ArrayList<ContentProtection> build() {
			if(adaptationSetProtections == null) {
		 ...
		 */
		private
		void maybeAddContentProtection(List<ContentProtection> contentProtections,
		...
		@Override
		public
		int compare(ContentProtection first, ContentProtection second) {
