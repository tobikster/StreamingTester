 ...
 */
public final
class FragmentedMp4Extractor implements Extractor {
	 ...
	 */
	public
	FragmentedMp4Extractor(int workaroundFlags) {
	...
	private
	void readAtomPayload(ExtractorInput input) throws IOException, InterruptedException {
	...
	private
	void onLeafAtomRead(LeafAtom leaf, long inputPosition) {
		if(!containerAtoms.isEmpty()) {
	...
	private
	void onContainerAtomRead(ContainerAtom container) {
	...
	private
	void onMoovContainerAtomRead(ContainerAtom moov) {
	...
	private
	void onMoofContainerAtomRead(ContainerAtom moof) {
		fragmentRun.reset();
	 ...
	 */
	private static
	DefaultSampleValues parseTrex(ParsableByteArray trex) {
	...
	private static
	void parseMoof(Track track, DefaultSampleValues extendsDefaults,
	 ...
	 */
	private static
	void parseTraf(Track track, DefaultSampleValues extendsDefaults,
	...
	private static
	void parseSaiz(TrackEncryptionBox encryptionBox, ParsableByteArray saiz,
	               TrackFragment out) {
	 ...
	 */
	private static
	DefaultSampleValues parseTfhd(DefaultSampleValues extendsDefaults,
	 ...
	 */
	private static
	long parseTfdt(ParsableByteArray tfdt) {
	 ...
	 */
	private static
	void parseTrun(Track track, DefaultSampleValues defaultSampleValues,
	...
	private static
	void parseUuid(ParsableByteArray uuid, TrackFragment out,
	...
	private static
	void parseSenc(ParsableByteArray senc, TrackFragment out) {
		parseSenc(senc, 0, out);
	}

	private static
	void parseSenc(ParsableByteArray senc, int offset, TrackFragment out) {
	 ...
	 */
	private static
	ChunkIndex parseSidx(ParsableByteArray atom, long inputPosition) {
	...
	private
	void readEncryptionData(ExtractorInput input) throws IOException, InterruptedException {
	 ...
	 */
	private
	boolean readSample(ExtractorInput input) throws IOException, InterruptedException {
	...
	private
	int appendSampleEncryptionData(ParsableByteArray sampleEncryptionData) {
	...
	private static
	boolean shouldParseAtom(int atom) {
	...
	private static
	boolean shouldParseContainerAtom(int atom) {
