 ...
 */
public
class SingleSampleChunkSource implements ChunkSource {
	 ...
	 */
	public
	SingleSampleChunkSource(DataSource dataSource, DataSpec dataSpec, Format format,
	...
	private
	SingleSampleMediaChunk initChunk() {
