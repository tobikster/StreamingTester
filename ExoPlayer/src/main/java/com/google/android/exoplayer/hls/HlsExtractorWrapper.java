 ...
 */
public final
class HlsExtractorWrapper implements ExtractorOutput {
	...
	public
	HlsExtractorWrapper(int trigger, Format format, long startTimeUs, Extractor extractor,
	 ...
	 */
	public final
	void configureSpliceTo(HlsExtractorWrapper nextExtractor) {
	 ...
	 */
	public
	long getLargestParsedTimestampUs() {
	 ...
	 */
	public
	boolean getSample(int track, SampleHolder holder) {
	 ...
	 */
	public
	void discardUntil(int track, long timeUs) {
		Assertions.checkState(isPrepared());
	...
	@Override
	public
	void drmInitData(DrmInitData drmInit) {
		// Do nothing.
	}
