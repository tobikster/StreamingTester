...
/* package */ final
	 ...
	 */
	public
	ParsableByteArray getParsableByteArray(ExtractorInput extractorInput, int length)
	 ...
	 */
	public
	int drainToOutput(TrackOutput trackOutput, int length) {
		if(length == 0) {
			return 0;
		}
	 ...
	 */
	public
	void skip(ExtractorInput extractorInput, int length)
			throws IOException, InterruptedException {
	 ...
	 */
	public
	void read(ExtractorInput extractorInput, byte[] target, int offset, int length)
			throws IOException, InterruptedException {
	 ...
	 */
	public
	boolean readAllowingEndOfInput(ExtractorInput extractorInput, byte[] target, int offset,
	                               int length) throws IOException, InterruptedException {
		return readInternal(extractorInput, target, offset, length);
	}

	private
	boolean readInternal(ExtractorInput extractorInput, byte[] target, int offset, int length)
	...
	private
	boolean ensureLoaded(ExtractorInput extractorInput, int length)
			throws InterruptedException, IOException {
