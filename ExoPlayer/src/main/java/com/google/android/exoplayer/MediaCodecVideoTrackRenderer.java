...
@TargetApi(16)
public
class MediaCodecVideoTrackRenderer extends MediaCodecTrackRenderer {
	 ...
	 */
	public
	interface EventListener extends MediaCodecTrackRenderer.EventListener {
	 ...
	 */
	public
	interface FrameReleaseTimeHelper {
	 ...
	 */
	public
	MediaCodecVideoTrackRenderer(SampleSource source, int videoScalingMode) {
	 ...
	 */
	public
	MediaCodecVideoTrackRenderer(SampleSource source, DrmSessionManager drmSessionManager,
	 ...
	 */
	private
	void setSurface(Surface surface) throws ExoPlaybackException {
	...
	@Override
	protected
	void onInputFormatChanged(MediaFormatHolder holder) throws ExoPlaybackException {
	 ...
	 */
	protected final
	boolean haveRenderedFirstFrame() {
	...
	@Override
	protected
	boolean processOutputBuffer(long positionUs, long elapsedRealtimeUs, MediaCodec codec,
	...
	protected
	void skipOutputBuffer(MediaCodec codec, int bufferIndex) {
	...
	protected
	void dropOutputBuffer(MediaCodec codec, int bufferIndex) {
	...
	protected
	void renderOutputBufferImmediate(MediaCodec codec, int bufferIndex) {
	...
	@TargetApi(21)
	protected
	void renderOutputBufferTimedV21(MediaCodec codec, int bufferIndex, long releaseTimeNs) {
		maybeNotifyVideoSizeChanged();
	...
	private
	void maybeNotifyVideoSizeChanged() {
	...
	private
	void maybeNotifyDrawnToSurface() {
	...
	private
	void maybeNotifyDroppedFrameCount() {
