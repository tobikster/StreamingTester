...
class Mp3Extractor implements Extractor {
	...
	@Override
	public
	int read(ExtractorInput extractorInput, PositionHolder seekPosition)
	...
	private
	long maybeResynchronize(ExtractorInput extractorInput)
			throws IOException, InterruptedException {
		inputBuffer.mark();
	...
	private
	long synchronizeCatchingEndOfInput(ExtractorInput extractorInput)
	throws IOException, InterruptedException {
	...
	private
	long synchronize(ExtractorInput extractorInput) throws IOException, InterruptedException {
	 ...
	 */
	private
	void setupSeeker(ExtractorInput extractorInput, long headerPosition)
			throws IOException, InterruptedException {
	 ...
	 */
	private
	boolean parseSeekerFrame(ExtractorInput extractorInput, long headerPosition,
	...
	private static
	long getPosition(ExtractorInput extractorInput, BufferingInput bufferingInput) {
