...
class TtmlParser implements SubtitleParser {
	 ...
	 */
	public
	TtmlParser(boolean strictParsing) {
	...
	private
	TtmlNode parseNode(XmlPullParser parser, TtmlNode parent) throws ParserException {
		long duration = 0;
	 ...
	 */
	private static
	long parseTimeExpression(String time, int frameRate, int subframeRate,
