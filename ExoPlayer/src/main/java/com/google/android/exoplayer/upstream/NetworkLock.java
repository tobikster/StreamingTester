...
class NetworkLock {
	 ...
	 */
	public static
	class PriorityTooLowException extends IOException {
	 ...
	 */
	public
	void proceed(int priority) throws InterruptedException {
		synchronized(lock) {
	 ...
	 */
	public
	void proceedOrThrow(int priority) throws PriorityTooLowException {
		synchronized(lock) {
