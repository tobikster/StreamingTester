...
class Ac3Util {
	...
	private static final int[] FRMSIZECOD_TO_FRAME_SIZE_44_1 = new int[] {
			                                                                     69, 87, 104, 121, 139, 174,
	 ...
	 */
	public static
	MediaFormat parseAnnexFAc3Format(ParsableByteArray data) {
		...
		return MediaFormat.createAudioFormat(MimeTypes.AUDIO_AC3, MediaFormat.NO_VALUE,
		                                     MediaFormat.NO_VALUE, channelCount, sampleRate, Collections
				                                                                                     .<byte[]>emptyList());
	}
	 ...
	 */
	public static
	MediaFormat parseAnnexFEAc3Format(ParsableByteArray data) {
	 ...
	 */
	public static
	MediaFormat parseFrameAc3Format(ParsableBitArray data) {
	 ...
	 */
	public static
	int parseFrameSize(ParsableBitArray data) {
		// Skip syncword and crc1.
		data.skipBits(4 * 8);
	 ...
	 */
	public static
	int getBitrate(int bufferSize, int sampleRate) {
