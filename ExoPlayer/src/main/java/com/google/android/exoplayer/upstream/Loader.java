...
class Loader {
	 ...
	 */
	public static final
	class UnexpectedLoaderException extends IOException {

		public
		UnexpectedLoaderException(Exception cause) {
			super("Unexpected " + cause.getClass()
			                           .getSimpleName() + ": " + cause.getMessage(), cause);
		}
	 ...
	 */
	public
	void startLoading(Loadable loadable, Callback callback) {
	 ...
	 */
	public
	void startLoading(Loadable loadable, Callback callback, int delayMs) {
		Looper myLooper = Looper.myLooper();
		Assertions.checkState(myLooper != null);
	 ...
	 */
	public
	void startLoading(Looper looper, Loadable loadable, Callback callback) {
	 ...
	 */
	public
	void startLoading(Looper looper, Loadable loadable, Callback callback, int delayMs) {
	...
	private final
	class LoadTask extends Handler implements Runnable {
		...
		public
		LoadTask(Looper looper, Loadable loadable, Loader.Callback callback, int delayMs) {
			super(looper);
