...
class SubtitleParserHelper implements Handler.Callback {
	 ...
	 */
	public
	SubtitleParserHelper(Looper looper, SubtitleParser parser) {
	 ...
	 */
	public synchronized
	Subtitle getAndClearResult() throws IOException {
		try {
			if(error != null) {
				throw error;
			}
