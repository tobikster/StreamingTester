...
class H264Util {
	 ...
	 */
	public static
	void replaceLengthPrefixesWithAvcStartCodes(ByteBuffer buffer, int size) {
	 ...
	 */
	public static
	byte[] parseChildNalUnit(ParsableByteArray atom) {
	 ...
	 */
	public static
	int getNalUnitType(byte[] data, int offset) {
	 ...
	 */
	public static
	int findNalUnit(byte[] data, int startOffset, int endOffset,
	                boolean[] prefixFlags) {
	 ...
	 */
	public static
	void clearPrefixFlags(boolean[] prefixFlags) {
		prefixFlags[0] = false;
		prefixFlags[1] = false;
		prefixFlags[2] = false;
	}
	 ...
	 */
	private static
	int readUnsignedIntToInt(ByteBuffer data) {
