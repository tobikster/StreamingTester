...
class SmoothStreamingManifest {
	 ...
	 */
	public
	SmoothStreamingManifest(int majorVersion, int minorVersion, long timescale, long duration,
	...
	class ProtectionElement {
		...
		public
		ProtectionElement(UUID uuid, byte[] data) {
			this.uuid = uuid;
			this.data = data;
		}
	 ...
	 */
	public static
	class TrackElement implements FormatWrapper {

		public final Format format;
		public final byte[][] csd;

		public
		TrackElement(int index, int bitrate, String mimeType, byte[][] csd, int maxWidth,
	...
	class StreamElement {
		...
		public
		StreamElement(String baseUri, String chunkTemplate, int type, String subType,
		...
		Uri buildRequestUri(int track, int chunkIndex) {
			...
			String chunkUrl = chunkTemplate
					                  ...
					                  .replace(URL_PLACEHOLDER_START_TIME, chunkStartTimes.get(chunkIndex)
					                                                                      .toString());
