...
class UrlTemplate {
	 ...
	 */
	public static
	UrlTemplate compile(String template) {
	 ...
	 */
	private
	UrlTemplate(String[] urlPieces, int[] identifiers, String[] identifierFormatTags,
	            int identifierCount) {
	 ...
	 */
	public
	String buildUri(String representationId, int segmentNumber, int bandwidth, long time) {
	 ...
	 */
	private static
	int parseTemplate(String template, String[] urlPieces, int[] identifiers,
