 ...
 */
/* package */ final
              class DefaultEbmlReader implements EbmlReader {
	...
	@Override
	public
	void init(EbmlReaderOutput eventHandler) {
	 ...
	 */
	private
	long readInteger(ExtractorInput input, int byteLength)
	 ...
	 */
	private
	double readFloat(ExtractorInput input, int byteLength)
			throws IOException, InterruptedException {
	 ...
	 */
	private
	String readString(ExtractorInput input, int byteLength)
			throws IOException, InterruptedException {
