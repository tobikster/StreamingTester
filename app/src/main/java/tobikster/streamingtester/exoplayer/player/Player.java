 ...
 */
package tobikster.streamingtester.exoplayer.player;
...
public class Player implements ExoPlayer.Listener,
  ...
  /* package */ void onRenderersError(Exception e) {
	...
	public interface RendererBuilder {
		 ...
		 * <p/>
		 * A canceled build operation must not invoke {@link Player#onRenderers} or {@link Player#onRenderersError} on
		 * the player, which may have been released.
		 */
		void cancel();
	}
	 ...
	 * {@link Listener#onError(Exception)} will be invoked.
	 */
