 ...
 */
public
class ExoPlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener, DemoPlayer.Listener, DemoPlayer.TextListener, DemoPlayer.Id3MetadataListener, AudioCapabilitiesReceiver.Listener {
	...
	void onResume() {
		...
		registerReceiver(mMediaParametersReceiver, mediaParametersIntentFilter);
	}
	...
	void onPause() {
		...
		unregisterReceiver(mMediaParametersReceiver);
	}
