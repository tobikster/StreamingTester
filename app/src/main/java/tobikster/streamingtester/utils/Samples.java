...
class Samples {
	...
	public static final Sample[] YOUTUBE_DASH_MP4 = new Sample[] {
			                                                             new Sample("Google Glass",
			                                                                        ...
			                                                                        ExoPlayerFragment.TYPE_DASH), new Sample("Google Play",
	...
	public static final Sample[] SMOOTHSTREAMING = new Sample[] {
			                                                            new Sample("Super speed",
			                                                                       ...
			                                                                       ExoPlayerFragment.TYPE_SS), new Sample("Super speed (PlayReady)",
			                                                                                                              "http://playready.directtaps.net/smoothstreaming/SSWSS720H264PR/SuperSpeedway_720.ism",
			                                                                                                              ExoPlayerFragment.TYPE_SS),
	};

	public static final Sample[] WIDEVINE_GTS = new Sample[] {
			                                                         new Sample("WV: HDCP not specified",
			                                                                    "d286538032258a1c",
			                                                                    "http://www.youtube.com/api/manifest/dash/id/d286538032258a1c/source/youtube?as=fmp4_audio_cenc,fmp4_sd_hd_cenc&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&ipbits=0&expire=19000000000&signature=477CF7D478BE26C205045D507E9358F85F84C065.8971631EB657BC33EC2F48A2FF4211956760C3E9&key=ik0",
			                                                                    ExoPlayerFragment.TYPE_DASH),
			                                                         new Sample("WV: HDCP not required",
			                                                                    "48fcc369939ac96c",
			                                                                    "http://www.youtube.com/api/manifest/dash/id/48fcc369939ac96c/source/youtube?as=fmp4_audio_cenc,fmp4_sd_hd_cenc&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&ipbits=0&expire=19000000000&signature=171DAE48D00B5BE7434BC1A9F84DAE0463C7EA7A.0925B4DBB5605BEE9F5D088C48F25F5108E96191&key=ik0",
			                                                                    ExoPlayerFragment.TYPE_DASH),
			                                                         new Sample("WV: HDCP required",
			                                                                    "e06c39f1151da3df",
			                                                                    "http://www.youtube.com/api/manifest/dash/id/e06c39f1151da3df/source/youtube?as=fmp4_audio_cenc,fmp4_sd_hd_cenc&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&ipbits=0&expire=19000000000&signature=8D3B8AF4E3F72B7F127C8D0D39B7AFCF37B30519.A118BADEBF3582AD2CC257B0EE6E579C6955D8AA&key=ik0",
			                                                                    ExoPlayerFragment.TYPE_DASH),
			                                                         new Sample("WV: Secure video path required",
			                                                                    "0894c7c8719b28a0",
			                                                                    "http://www.youtube.com/api/manifest/dash/id/0894c7c8719b28a0/source/youtube?as=fmp4_audio_cenc,fmp4_sd_hd_cenc&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&ipbits=0&expire=19000000000&signature=A41D835C7387885A4A820628F57E481E00095931.9D50DBEEB5E37344647EE11BDA129A7FCDE8B7B9&key=ik0",
			                                                                    ExoPlayerFragment.TYPE_DASH),
			                                                         new Sample("WV: HDCP + secure video path required",
			                                                                    "efd045b1eb61888a",
			                                                                    "http://www.youtube.com/api/manifest/dash/id/efd045b1eb61888a/source/youtube?as=fmp4_audio_cenc,fmp4_sd_hd_cenc&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&ipbits=0&expire=19000000000&signature=A97C9032C9D0C74F1643DB17C178873887C229E4.0A657BF6F23C8BC1538F276137383478330B76DE&key=ik0",
			                                                                    ExoPlayerFragment.TYPE_DASH),
			                                                         new Sample("WV: 30s license duration (fails at ~30s)",
			                                                                    "f9a34cab7b05881a",
			                                                                    "http://www.youtube.com/api/manifest/dash/id/f9a34cab7b05881a/source/youtube?as=fmp4_audio_cenc,fmp4_sd_hd_cenc&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&ipbits=0&expire=19000000000&signature=80648A12A7D5FC1FA02B52B4250E4EB74CF0C5FD.66A261130CA137AA5C541EA9CED2DBF240829EE6&key=ik0",
			                                                                    ExoPlayerFragment.TYPE_DASH),
	};
	...
	public static final Sample[] MISC = new Sample[] {
			                                                 ...
			                                                 new Sample("Apple AAC 10s",
			                                                            "https://devimages.apple.com.edgekey.net/streaming/examples/bipbop_4x3/gear0/fileSequence0.aac",
			                                                            ExoPlayerFragment.TYPE_OTHER),
			                                                 new Sample("Apple TS 10s",
	...
	public static final Sample[] WEB_MISC = new Sample[] {
			                                                     ...
			                                                     new Sample("Apple AAC 10s",
			                                                                "file:///android_asset/www/misc/audio_1/index.html",
			                                                                ExoPlayerFragment.TYPE_OTHER),
			                                                     ...
			                                                     new Sample("Google Glass (WebM Video with Vorbis Audio)",
			                                                                "file:///android_asset/www/misc/video_4/index.html",
			                                                                ExoPlayerFragment.TYPE_OTHER),
	};
	...
	public static final Sample[] LOCAL_SERVER = new Sample[] {
			                                                         new Sample("Big Buck Bunny - MP4",
			                                                                    "http://192.168.0.4/~tobikster/streamingtester/files/video_2.mp4",
			                                                                    ExoPlayerFragment.TYPE_OTHER),
			                                                         new Sample("Tears of steel (DASH)",
			                                                                    "http://192.168.0.4/~tobikster/streamingtester/dash/tears_of_steel/stream.mpd",
			                                                                    ExoPlayerFragment.TYPE_DASH),
			                                                         ...
			                                                         new Sample("Big Buck Bunny - DASH",
			                                                                    "http://192.168.0.4/~tobikster/streamingtester/dash/BigBuckBunny/MPDs/BigBuckBunny_1s_isoffmain_DIS_23009_1_v_2_1c2_2011_08_30.mpd",
			                                                                    ExoPlayerFragment.TYPE_DASH),
