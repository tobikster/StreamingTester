 ...
 */
public
class ExoPlayerFragment extends Fragment implements SurfaceHolder.Callback,
                                                    OnClickListener,
                                                    Player.Listener,
	...
	private static
	String buildTrackName(MediaFormat format) {
		if(format.adaptive) {
			return "auto";
		}
		String trackName;
	...
	private static
	String buildTrackIdString(MediaFormat format) {
	...
	private
	Player.RendererBuilder getRendererBuilder() {
