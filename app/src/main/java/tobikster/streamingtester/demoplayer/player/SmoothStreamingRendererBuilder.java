 ...
 */
public
class SmoothStreamingRendererBuilder implements DemoPlayer.RendererBuilder {
	...
	class AsyncRendererBuilder
		...
		public
		AsyncRendererBuilder(Context context, String userAgent, String url,
