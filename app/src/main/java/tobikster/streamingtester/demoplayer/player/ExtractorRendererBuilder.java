 ...
 */
public
class ExtractorRendererBuilder implements DemoPlayer.RendererBuilder {
	...
	public
	ExtractorRendererBuilder(Context context, String userAgent, Uri uri, TextView debugTextView, Extractor extractor) {
